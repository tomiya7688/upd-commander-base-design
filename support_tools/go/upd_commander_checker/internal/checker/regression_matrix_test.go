...
func TestCommanderRulesMatrix(t *testing.T) {
	...
	assertHasCode(codeAssertionInput{t: t, findings: findings, code: "UPD202"})
...
func TestContainerRulesMatrix(t *testing.T) {
	...
	findings := ScanPath(root, nil)
	assertHasCode(codeAssertionInput{t: t, findings: findings, code: "UPD301"})
	assertHasCode(codeAssertionInput{t: t, findings: findings, code: "UPD302"})
	assertHasCode(codeAssertionInput{t: t, findings: findings, code: "UPD303"})
}
...
func TestConstructorLikePackageFunctionIsNotChecked(t *testing.T) {
	...
	findings := ScanPath(root, nil)
	assertNoCode(codeAssertionInput{t: t, findings: findings, code: "UPD301"})
}
